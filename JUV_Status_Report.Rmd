...
ASE_df <- summariseRST()[[3]] %>%
  filter(MigratoryYear == 2017) %>%
  select(POP_NAME, SpeciesRun, StreamName, LocationLabel, SampleType, Origin, BroodYear, MigratoryYear, Year, Lifestage, Abundance, Ab_SE, Ab_L95, Ab_U95, ReleaseType, ReleaseGroup, AdClipped, SurvivalTo, Survival, Surv_SE, Surv_L95, Surv_U95, Equivalents)

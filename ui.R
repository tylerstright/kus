  ...
  navbarPage(title = div(div(id = 'user-name', textOutput('full_name')),
             ...
             tabPanel("Kus Home",
                      ...
                      fluidPage(
                        ...
                        fluidRow(
                          column(12, helpText('The Nez Perce Tribe Centralized Data Management System (CDMS) and Shiny applications are designed to support advanced data acquisition, data storage and management, data integration, data mining, and data visualization.  Additionally, the purpose of this system is to ultimately facilitate secure, redundant storage, maintenance, and efficient exchange of science-based information generated by NPT DFRM while preserving data integrity.  As a result, this system increases DFRM’s capacity to support individual and regional reporting, collaborative analyses, and informed policy and management decisions.  All this is accomplished by utilizing standardized performance measures as recommended by the Ad Hoc Supplementation Work Group (Beasley et al. 2008).', width = '100%'))
                        )
                        # fluidRow(
